...
float Uin_A,Uin_B,Uin_C,Uin_d,Uin_q;
...
volatile uint16_t buffer_d[100];
...
GPIO_writePin(36,1);
    ...
    Uin_A=ADC_DATA[1]*0.276f-558.0f;
    Uin_B=ADC_DATA[3]*0.276f-558.0f;
    Uin_C=ADC_DATA[7]*0.276f-558.0f;
...
/*
    ...
    */
    ...
    //PWM
    User_Waveform_Generation(U_16bit,1000,0,myEPWM2_BASE,myEPWM1_BASE);
    User_Waveform_Generation(V_16bit,1000,0,myEPWM4_BASE,myEPWM3_BASE);
    User_Waveform_Generation(W_16bit,1000,0,myEPWM7_BASE,myEPWM6_BASE);
...
void I_pid(void)//78Khz
{
    ...
    //limit
    Max_min(&Forward_Dset_normalization,0.96);
    Max_min(&Forward_Qset_normalization,0.96);
}
